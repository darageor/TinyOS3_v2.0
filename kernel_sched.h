...
typedef struct thread_control_block {
  ...
  //edited for part 1.2
  int pr_level; /**< @brief The priority level of the tcb in the scheduler*/
  int c_sum;    /**< @brief The calculator for counting the loops before we make the priority higher*/
