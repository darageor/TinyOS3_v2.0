...
//edited for part 2.2
typedef struct connection_request c_request;		/**< @brief Forward declaration */
typedef struct listener_socket listener_socket;		/**< @brief Forward declaration */
typedef struct unbound_socket unbound_socket;		/**< @brief Forward declaration */
...
typedef struct resource_list_node {
  ...
  union {
    ...
    //edited for part 2.2
    c_request* req_queue;
    listener_socket* listener_queue;
    unbound_socket* unbound_queue;
    void* obj;
    rlnode_ptr node;
    intptr_t num;
    uintptr_t unum;
