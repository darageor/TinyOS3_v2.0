...
typedef struct process_control_block {
  ...
  int thread_count;       /**< @brief The counter for the ptcb existing in the @c ptcb_list */
...
typedef struct process_thread_control_block{
  TCB* tcb;   /**< @brief Pointer to Thread*/

  Task task;  /**< @brief Thread's task*/
  int argl;   /**< @brief Task's argument length */                  
  void* args; /**< @brief Task's arguments*/  

  int exitval;    /**< @brief Thread's exit value */

  int exited;   /**< @brief To check if a thread exited */
  int detached;   /**< @brief To check if a thread is detached */

  CondVar exit_cv;    /**< @brief Condition variable to wait for exit*/

  int refcount;   /**< @brief Counter for waiting threads*/
  rlnode ptcb_list_node;    /**< @brief PTCB list's node*/
} PTCB;
/**
